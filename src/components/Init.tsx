...
const Features = () => {
  return (
    <div className="md:max-w-4xl md:mx-auto mx-6 max-md:my-8 text-center">
      ...
      <p className="text-sm md:text-base my-1 text-muted-foreground">No more endless file searching. Aura UI delivers the perfect code snippets right to your fingertips.</p>
      <div className="flex flex-col gap-4 md:my-12 my-6">
        <div className="flex flex-col md:flex-row gap-4 md:gap-8 md:text-left min-h-[18rem] justify-center items-center">
          <div className="md:p-8 space-y-2">
            <h2 className="font-sans font-bold tracking-tight text-3xl">Initialize Aura UI</h2>
            <p className="text-muted-foreground text-sm">Set up Aura UI in your project with a single command and get your configuration ready.</p>
          </div>
          <Terminal command={"npx aura-ui init"} />
        </div>
        <div className="flex flex-col-reverse md:flex-row gap-4 md:gap-8 md:text-left min-h-[18rem] justify-center items-center">
          <Terminal command={"npx aura-ui add {compName}"} />
          <div className="md:p-8 space-y-2">
