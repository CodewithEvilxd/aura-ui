    ...
    <div className="p-8 md:px-44">
      <div className="flex justify-between items-center gap-4 max-md:flex-col">
        <div className="flex flex-col gap-2 text-sm">
          <div className="flex gap-2 items-center">
            ...
            />
            <h2 className="text-2xl font-sans font-bold tracking-tight">Aura UI</h2>
          </div>
          <p>A product by Raj</p>
        </div>
      ...
      <div className="flex justify-between items-center max-md:mt-8">
        ...
        <div className="flex items-center gap-2">
          <Link href={"https://github.com/codewithevilxd/aura-ui"} target={"_blank"} className="p-2 rounded-full cursor-pointer"><FaGithub size={18} /></Link>
          <Link href={"https://x.com/raj.dev_X"} target={"_blank"} className="p-2 rounded-full cursor-pointer"><FaXTwitter size={18} /></Link>
        </div>
      </div>
    </div>
  )
