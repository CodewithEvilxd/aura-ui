...
First things first, let's get Aura UI into your project. It's like adopting a pet, but this one won't eat your code (we hope).

### Setting Up Aura UI

Now, here's where the magic happens and your kind of easy life starts -

1. First, initialize Aura UI in your project (if you haven't already). Choose your weapon of choice:

<InstallationCommand command={'init'} />

2. This will magically create a aura-ui.config.json file in the root of your project.
...
1. Start using Aura UI's utility functions
2. Customize your Aura UI components
